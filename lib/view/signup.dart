...
import 'package:chatflutter_app/view/chatRoomsScreen.dart';
...
class SignUpState extends State<SignUp> {
  ...
  TextEditingController mailTextEditingController = new TextEditingController();
  ...
  signMeUp()  {
    if (formKey.currentState.validate()) {
      ...
      authMetods
          .signUpWithEmailAndPassword(mailTextEditingController.text,
